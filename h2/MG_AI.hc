...
entity found;
float okay;
	if(self.controller.enemy!=world&&self.controller.enemy.flags2&FL_ALIVE&&visible(self.controller.enemy)&&self.controller.classname != "player")
	{
...
//		tracearea (org, destiny, '-16 -16 0','16 16 28',FALSE,self);
	...
	if(trace_ent.health>25||!trace_ent.takedamage||
	  (trace_ent.flags&FL_MONSTER&&trace_ent.classname!="player_sheep" && self.controller.classname != "player"))//target not monster, and target not sheep, and self not summoned by player
